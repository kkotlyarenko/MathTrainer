...
public class DelMid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        our1RandomNumber = (int) ( Math.random() * 200 ) + 10;
        our2RandomNumber = (int) ( Math.random() * 200 ) + 10;
        while (true) {
        ...
        sled.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DelMid.this, DelMid.class));
                finish();
            }
        });
