...
public class UmnLeg extends AppCompatActivity {
    Button otvetb, sled, back;
    private Activity mActivity;
    Random randint = new Random();
    int our1RandomNumber = randint.nextInt( 11);
    int our2RandomNumber = randint.nextInt(11);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sled.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UmnLeg.this, UmnLeg.class));
                finish();
            }
        });
