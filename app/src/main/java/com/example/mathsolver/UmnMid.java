...
public class UmnMid extends AppCompatActivity {
    Button otvetb, sled, back;
    private Activity mActivity;
    Random randint = new Random();
    int our1RandomNumber = randint.nextInt( 51) + 10;
    int our2RandomNumber = randint.nextInt(51) + 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sled.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UmnMid.this, UmnMid.class));
                finish();
            }
        });
